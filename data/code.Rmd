...
Dự đoán giá trị:
```{r}
prediction <- data.frame(new_cases=c(500000), new_tests=c(2000000), hosp_patients=c(100000), positive_rate = c(0.2))
predict(model, prediction , interval = 'confidence')
```
Trong ví dụ trên, với new_cases = 500000, new_tests = 2000000, hosp_patients = 100000 và positive_rate = 0.2, giá trị dự đoán của new_deaths sẽ là 86334.24, với -83858.88 và 256527.4 lần lượt là giới hạn tin cậy dưới và trên, mức tin cậy mặc định 95%.
